...
(function (YA) {
    ...
    var Component = /** @class */ (function (_super) {
        ...
        Component.prototype.subscribe = function (event, handler, capture) {
            ...
            if (convertor) {
                ...
                if (!funcs_1) {
                    ...
                    (function (fns) { return YA.attach(_this.element, event, function (sender, evt) {
                        var args;
                        if (evt === undefined) {
                            evt = sender;
                            sender = undefined;
        ...
        Component.prototype.visible = function (value) {
            if (value === undefined) {
                ...
                if (this._disNone === undefined) {
                    var v = YA.getStyle(this.element, "display");
                    if (v === "none")
                        v = "block";
                    else
                        this._disNone = v;
        ...
        Component.prototype.cursor = function (value) {
            if (value === undefined)
                return YA.getStyle(this.element, "cursor");
    ...
    YA.eventConvertors["mousemove"] = function (e) { return keyEventConvertor(e, mouseEventConvertor(e, { type: "mousemove" })); };
    YA.eventConvertors["mousedown"] = function (e) { return keyEventConvertor(e, mouseEventConvertor(e, { type: "mousedown" })); };
    YA.eventConvertors["mouseup"] = function (e) { return keyEventConvertor(e, mouseEventConvertor(e, { type: "mouseup" })); };
    YA.eventConvertors["mouseenter"] = function (e) { return keyEventConvertor(e, mouseEventConvertor(e, { type: "mouseenter" })); };
    YA.eventConvertors["mouseout"] = function (e) { return keyEventConvertor(e, mouseEventConvertor(e, { type: "mouseout" })); };
    ...
    YA.eventConvertors["keypress"] = function (e) { return keyEventConvertor(e, { type: "keypress" }); };
